...
#ifndef EXPLANATION_VIDEO_VIDEO_VIDEO_SERIALIZER_HPP_
#define EXPLANATION_VIDEO_VIDEO_VIDEO_SERIALIZER_HPP_
...
#endif  // EXPLANATION_VIDEO_VIDEO_VIDEO_SERIALIZER_HPP_
